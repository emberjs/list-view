// Version: v1.0.0-rc.2-82-gb669042
// Last commit: b669042 (2013-04-10 23:59:34 -0400)
...
/**
  Schedules an item to run one time during the current RunLoop in a particular queue.
  Calling this method with the same target/method combination will have no effect.
  ...
  @method scheduleOnce
  @param {String} queue the name of the queue to schedule action in
  @param {Object} [target] target of method to invoke.
  @param {Function|String} method The method to invoke.
    If you pass a string it will be resolved on the
    target at the time the method is invoked.
